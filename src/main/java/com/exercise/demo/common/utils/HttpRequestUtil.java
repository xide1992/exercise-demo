...
public class HttpRequestUtil {
     ...
     * @return
     */
    public static HttpRequestUtil connect(String url) {
     ...
     * @return
     */
    public static HttpRequestUtil connect(URL url) {
        HttpRequestUtil http = new HttpRequestUtil();
        http.url(url);
        return http;
    }
     ...
     * @return
     */
    public HttpRequestUtil url(URL url) {
        req.url(url);
        return this;
    }
     ...
     * @return
     */
    public HttpRequestUtil url(String url) {
     ...
     * @return
     */
    public HttpRequestUtil userAgent(String userAgent) {
     ...
     * @return
     */
    public HttpRequestUtil timeout(int millis) {
        req.timeout(millis);
        return this;
    }
     ...
     * @return
     */
    public HttpRequestUtil maxBodySize(int bytes) {
     ...
     * @return
     */
    public HttpRequestUtil followRedirects(boolean followRedirects) {
     ...
     * @return
     */
    public HttpRequestUtil referrer(String referrer) {
     ...
     * @return
     */
    public HttpRequestUtil method(Method method) {
        req.method(method);
        return this;
    }
     ...
     * @return
     */
    public HttpRequestUtil ignoreHttpErrors(boolean ignoreHttpErrors) {
     ...
     * @return
     */
    public HttpRequestUtil data(String key, String value) {
     ...
     * @return
     */
    public HttpRequestUtil data(Map<String, String> data) {
     ...
     * @return
     */
    public HttpRequestUtil data(String... keyvals) {
     ...
     * @return
     */
    public HttpRequestUtil header(String name, String value) {
     ...
     * @return
     */
    public HttpRequestUtil cookie(String name, String value) {
     ...
     * @return
     */
    public HttpRequestUtil cookies(Map<String, String> cookies) {
     ...
     * @return
     */
    public HttpRequestUtil parameter(String parameter) {
     ...
     * @return
     */
    public HttpRequestUtil request(Request request) {
        req = request;
        return this;
    }
    ...
    public static class Response extends Base<Response> {
        ...
        private static Response execute(Request req, Response previousResponse) throws IOException {
            ...
            try {
                ...
                if (req.method() == Method.POST || req.method() == Method.PUT || req.method() == Method.DELETE) {
                    writePost(req, conn.getOutputStream());
                }
                ...
                if (needsRedirect && req.followRedirects()) {
                    ...
                    for (Map.Entry<String, String> cookie : res.cookies().entrySet()) { // add response cookies to request (for e.g. login
                        // posts)
        ...
        private static HttpURLConnection createConnection(Request req) throws IOException {
            ...
            if (req.method() == Method.POST || req.method() == Method.DELETE || req.method() == Method.PUT) {
        ...
        private static void writePost(Request req, OutputStream outputStream) throws IOException {
            ...
            } else if (req.parameter != null && !req.parameter.isEmpty()) {
                w.write(req.parameter);
            }
        ...
        private static void serialiseRequestUrl(Request req) throws IOException {
            ...
            url.append(in.getProtocol()).append("://").append(in.getAuthority()) // includes host, port
            ...
            for (KeyVal keyVal : req.data()) {
                ...
                url.append(URLEncoder.encode(keyVal.key(), defaultCharset)).append('=')
